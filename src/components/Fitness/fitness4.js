...
const Fitness4 = ()=> (
 ...
 <div className="content-divider">
    <h1>Woman crushed to death while trying to lift 180kg barbell</h1>
    <div className="deatils-con">
       <div className="author">
          <div className="profile"></div>
          <div className="name">
            <p className="nm">Author Name</p>
            <p className="name-date">February 24 2022 - 10 min read</p>
          </div>
       </div>
       <div className="social"></div>
       <div className="content-img ft-card-img4"></div>
       <p  className="content-desc">Lifting weights is a common exercise. However, a woman was crushed to death while trying to lift almost 180 kg of barbell weight in a gym.</p>
