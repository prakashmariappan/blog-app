...
const Fitness2 = ()=> (
 ...
 <div className="content-divider">
    <h1>Are you guilty of making these five common yoga mistakes?</h1>
    <div className="deatils-con">
       <div className="author">
          <div className="profile"></div>
          <div className="name">
            <p className="nm">Author Name</p>
            <p className="name-date">April 08 2021 - 10 min read</p>
          </div>
       </div>
       <div className="social"></div>
       <div className="content-img ft-card-img2"></div>
       <p  className="content-desc">When it comes to fitness, there is nothing that can beat yoga, which is packed with physical and mental health benefits.</p>
