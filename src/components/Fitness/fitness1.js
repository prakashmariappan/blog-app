...
const Fitness1 = ()=> (
 ...
 <div className="content-divider">
    <h1>Just 10 minutes of daily exercise can benefit those over 40</h1>
    <div className="deatils-con">
       <div className="author">
          <div className="profile"></div>
          <div className="name">
            <p className="nm">Author Name</p>
            <p className="name-date">February 2 2022 - 10 min read</p>
          </div>
       </div>
       <div className="social"></div>
       <div className="content-img ft-card-img1"></div>
       <p  className="content-desc">Regular exercise plays an essential role in maintaining one’s health. Now, a research has also said that just 10 minutes of physical activity.</p>
