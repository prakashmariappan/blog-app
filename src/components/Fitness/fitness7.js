...
const Fitness7 = ()=> (
 ...
 <div className="content-divider">
    <h1>Classic Physique Champ Chris Bumstead</h1>
    <div className="deatils-con">
       <div className="author">
          <div className="profile"></div>
          <div className="name">
            <p className="nm">Author Name</p>
            <p className="name-date">February 25 2021 - 10 min read</p>
          </div>
       </div>
       <div className="social"></div>
       <div className="content-img ft-card-img7"></div>
       <p  className="content-desc">CBum talks about his rapid rise in popularity, his thoughts on his performance and he'll ever compete in the Open.</p>
