...
const Fitness6 = ()=> (
 ...
 <div className="content-divider">
    <h1>Yoga classes for Delhi Covid patients under home isolation</h1>
    <div className="deatils-con">
       <div className="author">
          <div className="profile"></div>
          <div className="name">
            <p className="nm">Author Name</p>
            <p className="name-date">February 26 2020 - 10 min read</p>
          </div>
       </div>
       <div className="social"></div>
       <div className="content-img ft-card-img6"></div>
       <p  className="content-desc">Under the ‘Delhi ki Yogshala" programme and 40,000 Covid-19 patients in home isolation can attend these online yoga classes.</p>
       <div className="content-tags">
          <p className="tags">Fitness</p>
          <p className="tags">Health</p>
          <p className="tags">Yoga</p>
       </div>
 ...
 <div className="left-content-con con-width">
    ...
    <div className="art-cards-con">
        ...
        <div className="artcardimg ft-card-img5"></div>
        <div className="art-card-content">
        <Link to='/fitness/fitness5'>Half of Americans Suffer from Gym Anxiety</Link>
        <p>At least 50% of Americans are intimidated to visit a gym, 24 Hour Fitness and fitness apps are trying to make working out easier.</p>
        <div className='la-field'>
            <h5>Fitness</h5>
            <h6>/ August 09 2020</h6>
        </div>
        </div>
        </div>
