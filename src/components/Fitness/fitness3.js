...
const Fitness3 = ()=> (
 ...
 <div className="content-divider">
    <h1>Here’s a 15-minute full body workout for people of all ages</h1>
    <div className="deatils-con">
       <div className="author">
          <div className="profile"></div>
          <div className="name">
            <p className="nm">Author Name</p>
            <p className="name-date">February 12 2022 - 10 min read</p>
          </div>
       </div>
       <div className="social"></div>
       <div className="content-img ft-card-img3"></div>
       <p  className="content-desc">Fitness is a mindset– a journey in itself where you have to stay motivated and determined to achieve the goals that you set for yourself.</p>
