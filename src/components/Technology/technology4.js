...
const Technology4 = ()=> (
 ...
 <div className="content-divider">
    <h1>Millions in Bitcoin pouring into Ukraine from donors</h1>
    <div className="deatils-con">
       ...
       <div className="content-img tch-card-img4"></div>
       <p  className="content-desc">Cryptocurrency analysts say at least $11m has so far been donated to the Ukrainian war effort through anonymous Bitcoin donations.</p>
       <div className="content-tags">
          <p className="tags">Technology</p>
          <p className="tags">Bitcoin</p>
          <p className="tags">Cryptocurrency</p>
       </div>
