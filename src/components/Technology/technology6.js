...
const Technology6 = ()=> (
 ...
 <div className="content-divider">
    <h1>Samsung apologises for Russian app download error</h1>
    <div className="deatils-con">
       <div className="author">
          <div className="profile"></div>
          <div className="name">
            <p className="nm">Author Name</p>
            <p className="name-date">October 08 2022 - 10 min read</p>
          </div>
       </div>
       <div className="social"></div>
       <div className="content-img tch-card-img6"></div>
       <p  className="content-desc">Samsung has apologised for a update sent to UK customers stating Russian government-mandated apps had been downloaded</p>
       <div className="content-tags">
          <p className="tags">Technology</p>
          <p className="tags">Internet</p>
          <p className="tags">Samsung</p>
       </div>
