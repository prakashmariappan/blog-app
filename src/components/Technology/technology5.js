...
const Technology5 = ()=> (
 ...
 <div className="content-divider">
    <h1>NHS Scotland's Covid Status app criticised over privacy failings</h1>
    <div className="deatils-con">
       <div className="author">
          <div className="profile"></div>
          <div className="name">
            <p className="nm">Author Name</p>
            <p className="name-date">February 20 2022 - 10 min read</p>
          </div>
       </div>
       <div className="social"></div>
       <div className="content-img tch-card-img5"></div>
       <p  className="content-desc">The NHS Scotland Covid Status app failed to provide people with clear details about how their personal information was being used.</p>
       <div className="content-tags">
          <p className="tags">Technology</p>
          <p className="tags">Internet</p>
          <p className="tags">Covid app</p>
       </div>
