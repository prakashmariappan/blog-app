...
const Technology2 = ()=> (
 ...
 <div className="content-divider">
    <h1>Asus ExpertBook B1400 lineup comes to India</h1>
    <div className="deatils-con">
       <div className="author">
          <div className="profile"></div>
          <div className="name">
            <p className="nm">Author Name</p>
            <p className="name-date">December 22 2021 - 10 min read</p>
          </div>
       </div>
       <div className="social"></div>
       <div className="content-img tch-card-img2"></div>
       <p  className="content-desc">ASUS has launched their new ExpertBook B1400 lineup of business-oriented laptops in India with the latest 11th Gen Intel processors.</p>
       <div className="content-tags">
          <p className="tags">Technology</p>
          <p className="tags">Laptop</p>
          <p className="tags">ASUS</p>
       </div>
