...
const Technology3 = ()=> (
 ...
 <div className="content-divider">
    <h1>Ukraine invasion: Russia restricts social media access</h1>
    <div className="deatils-con">
       ...
       <div className="content-img tch-card-img3"></div>
       <p  className="content-desc">The company said "We're aware that Twitter is being restricted for some people in Russia and are working to keep our services safe".</p>
       <div className="content-tags">
          <p className="tags">Technology</p>
          <p className="tags">Internet</p>
          <p className="tags">social media</p>
       </div>
