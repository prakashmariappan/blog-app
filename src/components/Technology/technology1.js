...
const Technology = ()=> (
 ...
 <div className="content-divider">
    <h1>Realme 9 Pro series to launch on February</h1>
    <div className="deatils-con">
       ...
       <div className="content-img tch-card-img1"></div>
       <p  className="content-desc">Realme today announced that its next number series mid-range smartphones, the Realme 9 Pro series, will be launching on February 16.</p>
       <div className="content-tags">
          <p className="tags">Technology</p>
          <p className="tags">Mobiles</p>
          <p className="tags">Realme</p>
       </div>
