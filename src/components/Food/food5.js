...
const Food5 = ()=> (
 ...
 <div className="content-divider">
    <h1>The Fruitarian Diet: Is It Good or Bad For You?</h1>
    <div className="deatils-con">
       <div className="author">
          <div className="profile"></div>
          <div className="name">
            <p className="nm">Author Name</p>
            <p className="name-date">March 12 2021 - 10 min read</p>
          </div>
       </div>
       <div className="social"></div>
       <div className="content-img fd-card-img5"></div>
       <p  className="content-desc">Dietitians can provide great advice when it comes to losing weight, nutritional plans and addressing lifestyles factors.</p>
