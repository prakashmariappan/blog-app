...
const Food1 = ()=> (
 ...
 <div className="content-divider">
    <h1>Spinach Can Turn Harmful if Consumed in Excess</h1>
    <div className="deatils-con">
       <div className="author">
          <div className="profile"></div>
          <div className="name">
            <p className="nm">Author Name</p>
            <p className="name-date">June 12 2021 - 10 min read</p>
          </div>
       </div>
       <div className="social"></div>
       <div className="content-img fd-card-img1"></div>
       <p  className="content-desc">Spinach is low in calories, loaded with healthy nutrients, rich in essential minerals, and vitamins.</p>
       <div className="content-tags">
          <p className="tags">Food</p>
          <p className="tags">Health</p>
          <p className="tags">Spinach</p>
       </div>
