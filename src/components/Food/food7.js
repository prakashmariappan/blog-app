...
const Food7 = ()=> (
 ...
 <div className="content-divider">
    <h1>Looking for summer drinks? Try out this cinnamon cold brew coffee</h1>
    <div className="deatils-con">
       <div className="author">
          <div className="profile"></div>
          <div className="name">
            <p className="nm">Author Name</p>
            <p className="name-date">June 18 2020 - 10 min read</p>
          </div>
       </div>
       <div className="social"></div>
       <div className="content-img fd-card-img7"></div>
       <p  className="content-desc">Refreshing iced coffee sweetened with the flavours of brown sugar and cinnamon sounds divine, doesn't it?</p>
       <div className="content-tags">
          <p className="tags">Food</p>
          <p className="tags">Health</p>
          <p className="tags">Drinks</p>
       </div>
