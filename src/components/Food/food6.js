    ...
    <div className="deatils-con">
       <div className="author">
          ...
          <div className="name">
            ...
            <p className="name-date">September 06 2022 - 10 min read</p>
          </div>
       </div>
       <div className="social"></div>
       <div className="content-img fd-card-img6"></div>
       <p  className="content-desc">The Mediterranean diet is based on the traditional foods that people used to eat in countries bordering the Mediterranean Sea.</p>
