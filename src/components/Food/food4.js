...
const Food4 = ()=> (
 ...
 <div className="content-divider">
    <h1>WFU’s Office of Wellbeing offering healthy eating tips</h1>
    <div className="deatils-con">
       <div className="author">
          <div className="profile"></div>
          <div className="name">
            <p className="nm">Author Name</p>
            <p className="name-date">April 20 2020 - 10 min read</p>
          </div>
       </div>
       <div className="social"></div>
       <div className="content-img fd-card-img4"></div>
       <p  className="content-desc">Wake Forest senior Erik Schultz doesn’t want to develop poor eating habits while he’s back at home in Asheboro sheltering.</p>
       <div className="content-tags">
          <p className="tags">Food</p>
          <p className="tags">Health</p>
          <p className="tags">WFU</p>
       </div>
