...
const Food2 = ()=> (
 ...
 <div className="content-divider">
    <h1>Kombucha For Your Gut</h1>
    <div className="deatils-con">
       <div className="author">
          <div className="profile"></div>
          <div className="name">
            <p className="nm">Author Name</p>
            <p className="name-date">February 13 2022 - 10 min read</p>
          </div>
       </div>
       <div className="social"></div>
       <div className="content-img fd-card-img2"></div>
       <p  className="content-desc">Kombucha is a fermented, fizzy, sweet, and sour tea that has been consumed for thousands of years</p>
       <div className="content-tags">
          <p className="tags">Food</p>
          <p className="tags">Health</p>
          <p className="tags">Kombucha</p>
       </div>
