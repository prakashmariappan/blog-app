...
const Bollywood3 = ()=> (
 ...
 <div className="content-divider">
    <h1>Sara flies to Rajkot for the shoot of her upcoming film Gaslight</h1>
    <div className="deatils-con">
       ...
       <div className="content-img bl-card-img3"></div>
       <p  className="content-desc">Riding high on the success of her last release Aanand L Rai’s Atrangi featuring Sara Ali Khan will be next seen in an project titled Gaslight.</p>
