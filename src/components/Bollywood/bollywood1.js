...
const Bollywood1 = ()=> (
 ...
 <div className="content-divider">
    <h1>Akshay Kumar & Emraan Hashmi's Film To Arrive Directly On OTT?</h1>
    <div className="deatils-con">
       ...
       <div className="content-img bl-card-img1"></div>
       <p  className="content-desc">Remakes have become a norm in Bollywood as most of them have worked exceptionally well in the past.</p>
