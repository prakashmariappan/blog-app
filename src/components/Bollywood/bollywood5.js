...
const Bollywood5 = ()=> (
 ...
 <div className="content-divider">
    <h1>Gangubai becomes first Indian film to be marketed on global platform</h1>
    <div className="deatils-con">
       ...
       <div className="content-img bl-card-img5"></div>
       <p  className="content-desc">Alia Bhatt is in the success of her film Gangubai Kathiawadi. The film marks the first collaboration between director Sanjay and Alia Bhatt.</p>
       <div className="content-tags">
          <p className="tags">Bollywood</p>
          <p className="tags">Movies</p>
          <p className="tags">Alia Bhatt</p>
       </div>
