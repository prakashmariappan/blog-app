...
const Bollywood4 = ()=> (
 ...
 <div className="content-divider">
    <h1>Salman Khan returns to Mumbai after a successful Da-Bangg tour in Dubai</h1>
    <div className="deatils-con">
       ...
       <div className="content-img bl-card-img4"></div>
       <p  className="content-desc">Superstar Salman Khan set the stage on fire on Friday night in Dubai at Expo 2020 as part of the Da-Bangg tour.</p>
