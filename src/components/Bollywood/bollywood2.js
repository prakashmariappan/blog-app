...
const Bollywood2 = ()=> (
 ...
 <div className="content-divider">
    <h1>The Internet Is Busy Crushing On Madhuri Dixit In An LBD</h1>
    <div className="deatils-con">
       <div className="author">
          <div className="profile"></div>
          <div className="name">
            <p className="nm">Author Name</p>
            <p className="name-date">February 3 2022 - 10 min read</p>
          </div>
       </div>
       <div className="social"></div>
       <div className="content-img bl-card-img2"></div>
       <p  className="content-desc">A black dress can go a long way to define one's sartorial choices.She has posted her photos in a stunning black midi dress.</p>
       <div className="content-tags">
          <p className="tags">Bollywood</p>
          <p className="tags">Movies</p>
          <p className="tags">Viral</p>
       </div>
