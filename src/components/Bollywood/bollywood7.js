...
const Bollywood7 = ()=> (
 ...
 <div className="content-divider">
    <h1>Raashii Khanna begins shoot of next schedule for Yodha</h1>
    <div className="deatils-con">
       <div className="author">
          <div className="profile"></div>
          <div className="name">
            <p className="nm">Author Name</p>
            <p className="name-date">February 25 2022 - 10 min read</p>
          </div>
       </div>
       <div className="social"></div>
       <div className="content-img bl-card-img7"></div>
       <p  className="content-desc">Creating waves across industries, Raashii Khanna is busy hopping sets and running around the clock one film after another.</p>
