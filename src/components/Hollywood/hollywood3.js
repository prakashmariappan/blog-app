    ...
    <div className="deatils-con">
       <div className="author">
          ...
          <div className="name">
            ...
            <p className="name-date">February 17 2022 - 10 min read</p>
          </div>
       </div>
       <div className="social"></div>
       <div className="content-img hl-card-img3"></div>
       <p  className="content-desc">Spider-Man: No Way Home might be getting a director’s cut soon. It has been two months since the Tom Holland starrer was released and now it is the third highest-grossing movie in US</p>
