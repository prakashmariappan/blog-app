...
const Hollywood1 = ()=> (
 ...
 <div className="content-divider">
    <h1>Robert Pattinson recalls being embarrassed by Andrew, Eddie</h1>
    <div className="deatils-con">
       <div className="author">
          <div className="profile"></div>
          <div className="name">
            <p className="nm">Author Name</p>
            <p className="name-date">July 26 2021 - 10 min read</p>
          </div>
       </div>
       <div className="social"></div>
       <div className="content-img hl-card-img1"></div>
       <p  className="content-desc">Robert Pattinson recalled how fellow actors Andrew Garfield and Eddie Redmayne would often outdo him at auditions years ago.</p>
       <div className="content-tags">
          <p className="tags">Hollywood</p>
          <p className="tags">Movies</p>
          <p className="tags">Spider Man</p>
       </div>
 ...
 <div className="left-content-con con-width">
    ...
    <div className="art-cards-con">
        ...
        <div className="artcards">
        <div className="artcardimg hl-card-img4"></div>
        <div className="art-card-content">
        <Link to='/hollywood/hollywood4'>Scarlett Johansson is world's best-paid actress, Forbes says</Link>
        <p>Helping to save the world with The Avengers has helped Scarlett Johansson become the best-paid actress in the world.</p>
        <div className='la-field'>
            <h5>Hollywood</h5>
