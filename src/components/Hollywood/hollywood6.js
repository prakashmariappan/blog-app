...
const Hollywood6 = ()=> (
 ...
 <div className="content-divider">
    <h1>Ghostbusters director Ivan Reitman dies at 75</h1>
    <div className="deatils-con">
       <div className="author">
          <div className="profile"></div>
          <div className="name">
            <p className="nm">Author Name</p>
            <p className="name-date">February 14 2022 - 10 min read</p>
          </div>
       </div>
       <div className="social"></div>
       <div className="content-img hl-card-img6"></div>
       <p  className="content-desc">Ivan Reitman, the influential filmmaker and producer behind beloved comedies from Animal House to Ghostbusters, has died at 75.</p>
       <div className="content-tags">
          <p className="tags">Hollywood</p>
          <p className="tags">Movies</p>
          <p className="tags">Ghostbusters</p>
       </div>
