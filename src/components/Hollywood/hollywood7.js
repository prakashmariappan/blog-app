...
const Hollywood7 = ()=> (
 ...
 <div className="content-divider">
    <h1>Rosamund Pike to star in pandemic thriller Rich Flu</h1>
    <div className="deatils-con">
       <div className="author">
          <div className="profile"></div>
          <div className="name">
            <p className="nm">Author Name</p>
            <p className="name-date">February 04 2022 - 10 min read</p>
          </div>
       </div>
       <div className="social"></div>
       <div className="content-img hl-card-img7"></div>
       <p  className="content-desc">Rich Flu sees a strange disease killing off some of the richest and most influential people on the planet starting with the billionaires.</p>
