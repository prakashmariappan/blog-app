    ...
    <div className="deatils-con">
       <div className="author">
          ...
          <div className="name">
            ...
            <p className="name-date">November 26 2020 - 10 min read</p>
          </div>
       </div>
       <div className="social"></div>
       <div className="content-img hl-card-img2"></div>
       <p  className="content-desc">Wonder Woman 1984 will be released in cinemas in many international markets ahead of its US debut on the big screen and on HBO Max on 25 December</p>
       <div className="content-tags">
          <p className="tags">Hollywood</p>
          <p className="tags">Movies</p>
          <p className="tags">Wonder Woman</p>
       </div>
