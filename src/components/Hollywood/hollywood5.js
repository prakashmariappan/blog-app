...
const Hollywood5 = ()=> (
 ...
 <div className="content-divider">
    <h1>Venom 2 release delayed to September</h1>
    <div className="deatils-con">
       ...
       <div className="content-img hl-card-img5"></div>
       <p  className="content-desc">The release of Venom: Let There Be Carnage, starring Tom Hardy and Woody Harrelson, has pushed been back to September 17.</p>
       <div className="content-tags">
          <p className="tags">Hollywood</p>
          <p className="tags">Movies</p>
          <p className="tags">Venom 2</p>
       </div>
